...
export class BomService {
  ...
  async getPackUnitById(id) {
    return this._http.get(this.backendService + 'packUnitById/' + id, this.httpOptions);
  }
  async getPackUnits() {
    return this._http.get(this.backendService + 'packUnits', this.httpOptions);
  }
  // Reports
  async getReports(dt) {
